...
int main() {
    ...
    //BRUTE FORCE : for every window of size k, iterate over i to i+k-1 and find max : O(n^2)

    // Efficient approach : slding window (deque), sqrt decom (may be),prirority queue
    ...
    cout<<a[Q.front()]<<endl;
    //last ans is pushed but not printed, so need to print separately
